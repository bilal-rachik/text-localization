...
from SSD.datasets import ICDARDataset
from SSD.utils import *
from  pathlib import Path

# Data parameters
data_folder =  Path(__file__).parent.parent.joinpath('data').as_posix() # folder with data files
...
# Learning parameters
checkpoint = None  #"checkpoint_ssd300.pth.tar" #'BEST_checkpoint_ssd300.pth.tar' #"checkpoint_ssd300.pth.tar"  # path to model checkpoint, None if none
